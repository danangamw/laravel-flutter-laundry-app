...
import 'package:dilaundry/datasources/laundry_datasource.dart';
import 'package:dilaundry/models/laundry_model.dart';
import 'package:dilaundry/models/models.dart';
import 'package:dilaundry/page/detail_laundry_page.dart';
import 'package:dilaundry/provider/my_laundry_provider.dart';
...
class _MyLaundryViewState extends ConsumerState<MyLaundryView> {
  ...
  getMyLaundry() {
    LaundryDatasource.readByUser(user.id).then((value) {
      setMyLaundryStatus(ref, 'loading');
      value.fold(
        (failure) {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [header(), categories(), laundries()],
    );
  }
        ...
        child: Consumer(
          builder: (_, wiRef, __) {
            ...
            if (statusCategory == 'All') {
              ...
              list =
                  listBackup.where((e) => e.status == statusCategory).toList();
            }
